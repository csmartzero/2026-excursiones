    ...
    <?php if ( have_posts() ) : ?>
        ...
        <div class="exc-archive__header">
            ...
            <div class="exc-controls">
                <div class="exc-controls__left">
                    <label for="exc-search" class="screen-reader-text">Buscar excursiones</label>
                    <input type="search" id="exc-search" class="exc-search" placeholder="Buscar por nombre..." />
                </div>
                <div class="exc-controls__right">
                    <label for="exc-price-order" class="screen-reader-text">Ordenar por precio</label>
                    <select id="exc-price-order" class="exc-select">
